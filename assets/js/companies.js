...
document.addEventListener('DOMContentLoaded', function () {
    ...
    companyForm.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const response = await fetch('../api/companies/save.php', {
                method: 'POST',
                body: formData,
                cache: 'no-store'
            });
    ...
    document.addEventListener("click", async (e) => {
        ...
        if (button) {
            try {
                const response = await fetch("../api/companies/switch.php", {
                    method: "POST",
                    headers: {
...
async function loadCompanies() {
    ...
    try {
        const response = await fetch('../api/companies/list.php?_=' + Date.now(), {
            cache: 'no-store'
        });
        const result = await response.json();
        if (!result.success) {

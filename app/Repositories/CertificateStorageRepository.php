...
class CertificateStorageRepository
{
    ...
    public function __construct(CompanyStorageRepository $storage)
    {
    ...
    public function updateCertificateValidity(int $companyId, string $certificate): void
    {
        $x509 = new X509();
    ...
    public function saveComplianceCertificate(
        object $result,
        string $csr,
        string $privateKey
    ): void
    ...
    public function saveProductionCredentials(
    ...
    ): void
    {
        ...
        $stmt->execute([
            ...
            $result->getCertificate(),
            $result->getRequestId(),
            (new CompanySettingsRepository())->getEnvironment(),
            $company['id']
        ]);
    }   
    
    public function saveCertificateSettings(array $settings): void
    {
        $pdo = Database::getConnection();
